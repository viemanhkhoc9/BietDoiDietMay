  ...
  <section id="service" class="home-section text-center bg-gray">
    ...
    <div id="pageintro" class="hoc clear">
				<article>
								...
								<a class="btn " style="background-color:#00FFFF; width:300px;height:50px" href="/create/news">Create New Post</a> <a
									class="btn" style="background-color:#00FFFF; width:300px;height:50px" href="/create/category">Create New Category</a>
							
					
				</article>
			<h3 style="color: #DC143C;margin-top:50px;"><i class="fa fa-cloud"></i> Notification !</h3>
